...
extern int linha, coluna, opt, parse, smantic, col, lin, comment, linha2, coluna2, erro;
extern char* yytext;
...
Program: FunctionsAndDeclarations	{raiz = insert_Program($1); if(smantic && opt){create_environment_list(&header, tabela, count + count%2, raiz); print_environment_list(header);} print_Program(raiz,opt);};
